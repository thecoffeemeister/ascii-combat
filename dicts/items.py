...
ITEMS = {
    ...
    'bow': {
        NAME: 'Bow',
        GROUNDDESC: ['A bow and some arrows', 'are thrown on the ground'],
        SHORTDESC: 'a wooden bow, ready to go',
        LONGDESC: 'This bow is made from yew, polished with Harpies blood, ready to shoot somebody, ',
        PICKABLE: True,
        EDIBLE: False,
        PRICE: 100,
        WEAPON: WEAPONS[BOW],
        SKILL: SKILLS[ARROWSTORM],
        TAG: 'weapon',
    },
    'coin': {
        NAME: 'Coin',
    ...
    'brigandine':{
        NAME: 'Brigandine',
        GROUNDDESC: ['A leather jacket which, upon inspection, turns out to be', '. Maybe it can protect you.'],
        SHORTDESC: 'brigandine',
        LONGDESC: "A Brigandine jacket, it will provide some protection.",
        PICKABLE: True,
        HEAL: 0,
        EDIBLE: False,
        PRICE: 50,
